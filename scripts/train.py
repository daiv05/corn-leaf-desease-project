...
train_dataset = CornDataset(csv_path=str(SPLITS_DIR / "train.csv"), transform=train_transforms)
val_dataset = CornDataset(csv_path=str(SPLITS_DIR / "val.csv"), transform=val_transforms)
