...
def evaluate_exported_model(
    ...
    *,
    ...
    predictions, confidences, labels = _predict_exported(runner, test_loader)
    ...
    if environments is not None and len(environments) == len(frame):
    ...
    if torch_model is not None:
        torch_predictions = _predict_torch(torch_model, test_loader, device)
